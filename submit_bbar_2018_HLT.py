...
voms_dir = f"/cms/ldap_home/seungjun/nano/MC_b_bbar_4l/run_HLT"+dir_name
work_dir = f"/cms/ldap_home/seungjun/nano/MC_b_bbar_4l/run_HLT"+dir_name
...
cmsDriver.py --python_filename HLT_cfg.py \\
             ...
             --filein file:{input_dir}/PREMIX_{job_id}.root --fileout file:HLT_{job_id}.root \\
