...
voms_dir = f"/cms/ldap_home/seungjun/nano/MC_b_bbar_4l/run_premix"+dir_name
work_dir = f"/cms/ldap_home/seungjun/nano/MC_b_bbar_4l/run_premix"+dir_name
...
cmsDriver.py --python_filename PREMIX_cfg.py \\
             ...
             --filein file:{input_dir}/GEN-SIM_{job_id}.root --fileout file:PREMIX_{job_id}.root \\
